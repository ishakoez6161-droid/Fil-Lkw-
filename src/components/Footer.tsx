      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-12 border-b border-white/10 pb-12 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <a
              href={site.phoneHref}
              className="btn-shine mt-5 inline-flex items-center gap-2 rounded-full bg-brand-500 px-5 py-3 text-sm font-bold text-ink-950 transition-transform hover:scale-[1.03]"
            >
              <Phone size={15} />
              Jetzt anrufen
            </a>
