...
export default function ServiceArea() {
  return (
    <section id="einsatzgebiet" className="relative bg-ink-50/60 py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-5">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
            className="relative overflow-hidden rounded-[2rem] shadow-soft ring-1 ring-ink-100 lg:col-span-3"
          >
            <iframe
              title="FIL Truck-Center Standort Karte"
              src={site.mapsEmbedSrc}
              className="h-[24rem] w-full grayscale-[15%] sm:h-[28rem]"
              loading="lazy"
          ...
          <motion.div
            ...
            className="flex flex-col justify-between rounded-[2rem] bg-ink-950 p-8 shadow-soft lg:col-span-2"
          >
            <div>
